    ...
    services.llama-swap = {
      ...
      in {
        ...
        in {
          ...
          # };
          "qwen" = {
            cmd = "${llama-server} --port \${PORT} -hf unsloth/Qwen3.6-35B-A3B-GGUF:UD-Q8_K_XL --fit-target 2048 --temp 1.0 --top-p 0.95 --top-k 20 --min-p 0.0 --repeat-penalty 1.0 --presence-penalty 1.5 --ctx-size 131072 --cache-type-k q8_0 --cache-type-v q8_0";
            inherit env;
          };
        };
      };
